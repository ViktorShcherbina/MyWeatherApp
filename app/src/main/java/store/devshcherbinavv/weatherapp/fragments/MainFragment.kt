...
import store.devshcherbinavv.weatherapp.DialogManager
import store.devshcherbinavv.weatherapp.MainViewModel
import store.devshcherbinavv.weatherapp.R
import store.devshcherbinavv.weatherapp.adapters.VpAdapter
...
class MainFragment : Fragment() {
    ...
    private fun permissionListener(){
        pLauncher = registerForActivityResult(
            ...
            Toast.makeText(activity, "Permisson is $it", Toast.LENGTH_SHORT).show()
